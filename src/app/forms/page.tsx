            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <Link href="/forms/bcp">
                    <motion.div 
                        ...
                        className="group relative p-8 bg-slate-900 border border-slate-800 rounded-3xl hover:border-violet-500/50 transition-all duration-500 overflow-hidden cursor-pointer shadow-2xl"
                    >
                        <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity text-violet-500">
                            <ClipboardList size={80} />
                        </div>
                        
                        <div className="relative z-10 space-y-6">
                            <div className="p-3 bg-violet-600/10 w-fit rounded-2xl group-hover:bg-violet-600 transition-all duration-500">
                                <ClipboardList size={24} className="text-violet-500 group-hover:text-white" />
                            </div>
                            <div className="space-y-2">
                                <h2 className="text-2xl font-bold text-white group-hover:text-violet-400 transition-colors uppercase tracking-tight">
                                    BCP / DR Test
                                </h2>
                                <p className="text-slate-400 leading-relaxed font-medium">
                                    Auto-generated Business Continuity & Disaster Recovery report for auditors.
                                </p>
                            </div>
                            <div className="flex items-center gap-2 text-violet-500 font-black text-xs uppercase tracking-widest pt-4 group-hover:gap-4 transition-all">
                                Generate PDF <ArrowRight size={14} />
                            </div>
                        </div>
                    </motion.div>
